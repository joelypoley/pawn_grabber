...
TEST(PseudoLegalMoves, A8Rook) {
  ...
  std::vector<Move> east_moves = {{a8, algebraic_to_square("b8")},
                                  {a8, algebraic_to_square("c8")},
                                  {a8, algebraic_to_square("d8")},
                                  {a8, algebraic_to_square("e8")}};
...
TEST(PseudoLegalMoves, F8Rook) {
  ...
  std::vector<Move> west_moves = {{f8, algebraic_to_square("e8")},
                                  {f8, algebraic_to_square("d8")},
                                  {f8, algebraic_to_square("c8")},
                                  {f8, algebraic_to_square("b8")}};
...
TEST(PseudoLegalMoves, G6Bishop) {
  ...
  std::vector<Move> northeast_moves = {{g6, algebraic_to_square("h7")}};
  std::vector<Move> southwest_moves = {{g6, algebraic_to_square("f5")}};
  std::vector<Move> southeast_moves = {{g6, algebraic_to_square("h5")}};
  EXPECT_TRUE(board.pseudolegal_moves_in_direction(northwest, g6).empty());
  EXPECT_EQ(board.pseudolegal_moves_in_direction(northeast, g6), northeast_moves);
  EXPECT_EQ(board.pseudolegal_moves_in_direction(southwest, g6), southwest_moves);
  EXPECT_EQ(board.pseudolegal_moves_in_direction(southeast, g6), southeast_moves);
}

TEST(PseudoLegalMoves, H4Queen) {
  Board board("r4rk1/pp3pp1/2p3bp/8/3Pp1nq/1QN1P2P/PP1N1PP1/R4R1K b - - 1 18");
  const Bitboard h4 = algebraic_to_square("h4");
  std::vector<Move> north_moves = {{h4, algebraic_to_square("h5")}};
  std::vector<Move> south_moves = {{h4, algebraic_to_square("h3")}};
  std::vector<Move> northwest_moves = {
    {h4, algebraic_to_square("g5")},
    {h4, algebraic_to_square("f6")},
    {h4, algebraic_to_square("e7")},
    {h4, algebraic_to_square("d8")},
  };
  std::vector<Move> southwest_moves = {
    {h4, algebraic_to_square("g3")},
    {h4, algebraic_to_square("f2")},
  };
  ...
  EXPECT_EQ(board.pseudolegal_moves_in_direction(northwest, h4), northwest_moves);
  EXPECT_EQ(board.pseudolegal_moves_in_direction(southwest, h4), southwest_moves);
}
