...
//   Board board("r4rk1/pp3pp1/2p3bp/8/3Pp1nq/1QN1P2P/PP1N1PP1/R4R1K w - - 1
//   18"); const Bitboard f1 = str_to_square("f1");
...
//   Board board("r4rk1/pp3pp1/2p3bp/8/3Pp1nq/1QN1P2P/PP1N1PP1/R4R1K w - - 1
//   18"); const Bitboard b3 = str_to_square("b3");
...
//   Board board("r4rk1/pp3pp1/2p3bp/8/3Pp1nq/1QN1P2P/PP1N1PP1/R4R1K b - - 1
//   18"); const Bitboard a8 = str_to_square("a8");
...
//   Board board("r4rk1/pp3pp1/2p3bp/8/3Pp1nq/1QN1P2P/PP1N1PP1/R4R1K b - - 1
//   18"); const Bitboard f8 = str_to_square("f8");
...
//   Board board("r4rk1/pp3pp1/2p3bp/8/3Pp1nq/1QN1P2P/PP1N1PP1/R4R1K b - - 1
//   18"); const Bitboard g6 = str_to_square("g6");
...
//   Board board("r4rk1/pp3pp1/2p3bp/8/3Pp1nq/1QN1P2P/PP1N1PP1/R4R1K b - - 1
//   18"); const Bitboard h4 = str_to_square("h4");
...
//   EXPECT_TRUE(
//       std::is_permutation(test_moves.begin(), test_moves.end(),
//       moves.begin()));
// }
...
//   Board board("rnbqkbnr/1pp1pppp/p7/3pP3/8/8/PPPP1PPP/RNBQKBNR w KQkq d6 0
//   3");
...
//   Board board("rnbqkbnr/1pp1pppp/8/2PpP3/p7/8/PP1P1PPP/RNBQKBNR w KQkq d6 0
//   5");
...
//   Board board_3 =
//       Board("rn2k2r/1pN1bppp/4pn2/3p3q/1P6/P1B1P3/2P2PPP/R2Q1RK1 b kq - 3
//       15");
...
//   Board board = Board();
//   EXPECT_EQ(number_of_moves(board, 0), 1);
//   EXPECT_EQ(number_of_moves(board, 1), 20);
//   EXPECT_EQ(number_of_moves(board, 2), 400);
//   EXPECT_EQ(number_of_moves(board, 3), 8902);
//   // EXPECT_EQ(number_of_moves(board, 4), 197281);
// }
...
//       1");
//   EXPECT_EQ(number_of_moves(board, 0), 1);
//   EXPECT_EQ(number_of_moves(board, 1), 48);
//   EXPECT_EQ(number_of_moves(board, 2), 2039);
//   EXPECT_EQ(number_of_moves(board, 3), 97862);
//   // EXPECT_EQ(number_of_moves(board, 4), 4085603);
// }

// TEST(Perft, Pos3) {
//   Board board = Board("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1");
//   EXPECT_EQ(number_of_moves(board, 0), 1);
//   EXPECT_EQ(number_of_moves(board, 1), 14);
//   EXPECT_EQ(number_of_moves(board, 2), 191);
//   EXPECT_EQ(number_of_moves(board, 3), 2812);
//   EXPECT_EQ(number_of_moves(board, 4), 43238);
// }

// TEST(Perft, Pos4) {
//   Board board =
//       Board("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0
//       1");
//   EXPECT_EQ(number_of_moves(board, 0), 1);
//   EXPECT_EQ(number_of_moves(board, 1), 6);
//   EXPECT_EQ(number_of_moves(board, 2), 264);
//   EXPECT_EQ(number_of_moves(board, 3), 9467);
//   // EXPECT_EQ(number_of_moves(board, 4), 422333);
// }
...
//   EXPECT_EQ(number_of_moves(board, 0), 1);
//   EXPECT_EQ(number_of_moves(board, 1), 44);
//   EXPECT_EQ(number_of_moves(board, 2), 1486);
//   EXPECT_EQ(number_of_moves(board, 3), 62379);
//   // EXPECT_EQ(number_of_moves(board, 4), 2103487);
// }
...
//       " "10");
//   EXPECT_EQ(number_of_moves(board, 0), 1);
//   EXPECT_EQ(number_of_moves(board, 1), 46);
//   EXPECT_EQ(number_of_moves(board, 2), 2079);
//   EXPECT_EQ(number_of_moves(board, 3), 89890);
//   // EXPECT_EQ(number_of_moves(board, 4), 3894594);
// }