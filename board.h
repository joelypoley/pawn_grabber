...
PositionArray position_array = {
	...
	0x0, 		// white bishops
	0x0, 		// white queens
	0x8, 		// white king Note: 0x8 = 0b1000 so there is a white king on square 4
	0x0, 		// black pawns
	0x0, 		// black rooks
	0x0, 		// black knights
	0x0, 		// black bishops
	0x0, 		// black queens
	0x800000000000000 	// black king 0x80...0 is a 64 bit uint with the 59th bit flipped to 1 and all other bits 0. Hence there is a black king on square 59
}
Only the black and white kings' bitboards are nonzero. A 0 in the n-th bit of the piecetype bitboard indicates there is no piece of that piecetype on square n; a 1 indicates that there is. 
